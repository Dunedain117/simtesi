...
//=========  (Mon Oct 20 12:53:04 2025) by ROOT version 6.36.04
   TCanvas *Canvas_1_n3 = new TCanvas("e- summary", "e- summary", 66, 71, 700, 500);
   gStyle->SetOptFit(0);
   ...
   TH1F *histoEle__3 = new TH1F("e- summary", "Energy Absorbtion in 3 um Si target | 200 keV e-", 100, 0, 0.02);
   ...
   histoEle__3->GetXaxis()->SetTitle("Energy deposit (MeV)");
   histoEle__3->GetYaxis()->SetTitle("Counts normalized");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_text14 = pt->AddText("aaaa");
   pt->Draw("blNDC");
