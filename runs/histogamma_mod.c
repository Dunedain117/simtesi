...
//=========  (Mon Oct 20 12:51:09 2025) by ROOT version 6.36.04
   TCanvas *Canvas_1_n3 = new TCanvas("Gamma summary", "Gamma Summary", 66, 71, 700, 500);
   gStyle->SetOptFit(0);
   ...
   TH1F *histoGamma__2 = new TH1F("Gamma summary", "Energy Absorbtion in 3 um Si target | 511 keV gamma", 100, 0, 0.0186);
   ...
   histoGamma__2->GetXaxis()->SetTitle("Energy deposit (MeV)");
   histoGamma__2->GetYaxis()->SetTitle("Counts normalized");
